...
/**
 * Responsible for serializing and deserializing world objects
 * 
 * @author xuset
 * @since 1.0
 */
public class WorldSerializer{
	...
	/**
	 * Serialize the given world into a MarkupMsg object.
	 * 
	 * @param world the world to serialized
	 * @return the message object containing the serialized world
	 */
	...
	/**
	 * Deserializes the given message object and creates a new world based
	 * off the message.
	 * 
	 * @param worldMsg the message to create the world from
	 * @return the newly create world
	 * @throws IllegalArgumentException if the message is a serialized world
	 * 		message
	 */
